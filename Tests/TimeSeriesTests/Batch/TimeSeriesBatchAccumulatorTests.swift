...
private enum TestsData {
    ...
    static var batchOfOneItem: Batch {
        Batch([.init(timeBase: FixedDate(100), items: [.init(time: 20, index: 0)])])
    }
    ...
    static var batchOf_8_Item: Batch {
        Batch([.init(timeBase: FixedDate(100), items:
            [
                .init(time: 10, index: 0),
                .init(time: 20, index: 1),
                .init(time: 30, index: 2),
                .init(time: 40, index: 3),
                .init(time: 150, index: 4),
                .init(time: 160, index: 5),
                .init(time: 170, index: 6),
                .init(time: 180, index: 7),
            ])])
    }
    ...
    static var batchOf_10_Item: Batch {
        Batch([
            .init(timeBase: FixedDate(100), items: [
                .init(time: 10, index: 0),
                .init(time: 20, index: 1),
                .init(time: 30, index: 2),
                .init(time: 40, index: 3),
            ...
            .init(timeBase: FixedDate(200), items: [
                .init(time: 90, index: 8),
                .init(time: 200, index: 9),
            ]),
