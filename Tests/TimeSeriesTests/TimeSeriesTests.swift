...
func timeSeriesNormalisation() throws {
...
@Test("Time normalization for slice")
func timeSeriesSliceNormalisation() throws {
    let normalized = TimeSeries(timeBase: FixedDate(100),
                                items: [
                                    MocItem(time: 0, index: 1),
                                    MocItem(time: 10, index: 2),
...
func timeSeriesUnionWithEmpty() throws {
